package com.bjlemon.eduorder.service.impl;

import com.alibaba.fastjson.JSONObject;
import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.bjlemon.commonutils.ResultCode;
import com.bjlemon.eduorder.entity.Order;
import com.bjlemon.eduorder.entity.PayLog;
import com.bjlemon.eduorder.mapper.PayLogMapper;
import com.bjlemon.eduorder.service.OrderService;
import com.bjlemon.eduorder.service.PayLogService;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.bjlemon.eduorder.utils.HttpClient;
...
public class PayLogServiceImpl extends ServiceImpl<PayLogMapper, PayLog> implements PayLogService {
    ...
    public Map createNatvie(String orderNo) {
        try {
            ...
            throw new LemonException(ResultCode.ERROR,"生成二维码失败");
        }
