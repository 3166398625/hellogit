...
import com.bjlemon.eduservice.entity.EduCourseDescription;
...
import com.bjlemon.eduservice.mapper.EduCourseMapper;
import com.bjlemon.eduservice.service.EduChapterService;
import com.bjlemon.eduservice.service.EduCourseDescriptionService;
...
public class EduCourseServiceImpl extends ServiceImpl<EduCourseMapper, EduCourse> implements EduCourseService {
    ...
    public String saveCourseInfo(CourseInfoVo courseInfoVo) {
        ...
        if(insert == 0) {
            //添加失败
            throw new LemonException(ResultCode.ERROR,"添加课程信息失败");
        }
    ...
    public void updateCourseInfo(CourseInfoVo courseInfoVo) {
        ...
        if(update==0){
            throw new LemonException(ResultCode.ERROR,"修改课程描述失败");
        }
    ...
    public void removeCourse(String courseId) {
        ...
        if(result == 0) { //失败返回
            throw new LemonException(ResultCode.ERROR,"删除失败");
        }
    }
