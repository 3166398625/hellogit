package com.bjlemon.ucenter.service.impl;
...
import com.bjlemon.ucenter.mapper.MemberMapper;
...
public class MemberServiceImpl extends ServiceImpl<MemberMapper, UcenterMember> implements MemberService {
    ...
    public String login(UcenterMember member) {
        ...
        if(StringUtils.isEmpty(mobile) || StringUtils.isEmpty(password)) {
            throw new LemonException(ResultCode.ERROR,"登录失败");
        }
    ...
    public void register(RegisterVo registerVo) {
        ...
        if(StringUtils.isEmpty(mobile) || StringUtils.isEmpty(password)
            ...
            throw new LemonException(ResultCode.ERROR,"注册失败");
        }
        //判断验证码
        //获取redis验证码
